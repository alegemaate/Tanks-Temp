...
void particle::draw(BITMAP* tempBitmap) {
  if (particleType == PIXEL) {
    putpixel(tempBitmap, x, y,
             makecol(particleRed, particleGreen, particleBlue));
  } else if (particleType == SQUARE) {
    rectfill(tempBitmap, x, y, x + particleSize, y + particleSize,
             makecol(particleRed, particleGreen, particleBlue));
  } else if (particleType == CIRCLE) {
    circlefill(tempBitmap, x, y, particleSize,
               makecol(particleRed, particleGreen, particleBlue));
