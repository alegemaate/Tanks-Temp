...
class tank {
 public:
  ...
  virtual void set_map_dimensions(int newMapWidth, int newMapHeight) {
    map_width = newMapWidth;
    map_height = newMapHeight;
  }
 ...
 protected:
  ...
  virtual void drawHealthBar(BITMAP* tempImage,
                             int newX,
                             int newY,
                             int newWidth,
                             int newHeight,
